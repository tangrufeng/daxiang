...
public class WxReceiverController {
    ...
    @ResponseBody
    public String receiveWxMsg(@RequestBody String xml, @RequestParam("signature") String signature, @RequestParam("timestamp") String timestamp, @RequestParam("nonce") String nonce, @RequestParam(value ="echostr",required=false,defaultValue = "") String echostr) {
        ...
        String msgType = "", event = "", eventKey = "", fromUserName = "";
        ...
        logger.info("parse from xml===msgType==>" + msgType + "===event====>" + event + "====eventKey====>" + eventKey + "==fromUserName===>" + fromUserName);
